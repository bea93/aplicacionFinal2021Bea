...
<div>
    <form name="formulario" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form">
        <div>
            ...
            <input class="desactivado" type="text" id="CodDepartamento" name="CodDepartamento" readonly value="<?php echo $codDep; ?>">
            <br>

            <label for="DescDepartamento" >Descripción de departamento</label><br>
            <input type="text" id="DescDepartamento" name="DescDepartamento" value="<?php echo isset($_REQUEST['DescDepartamento']) ? $_REQUEST['DescDepartamento'] : $descDep; ?>">
            ...
            <input class="desactivado" type="text" id="FechaCreacion" name="FechaCreacion" readonly value="<?php echo date('d/m/Y', $fechaCreacion); ?>">
            <br>
